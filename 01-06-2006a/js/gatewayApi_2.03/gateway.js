...
Gateway.prototype.serializeAndSend = function(_bUseCache){
	...
	if (this.formatPacket(this.sent).length > 2000) {
...
//alert('methodPost() :: ' + '(this.isWddxEnabled()) = [' + (this.isWddxEnabled()) + ']' + ((this.isWddxEnabled()) ? 'oForm.wddx.value = (' + oForm.wddx.value.length + ') [' + oForm.wddx.value + ']' : ', oForm.packet.value = (' + oForm.packet.value.length + ') [' + oForm.packet.value + ']') ); // +++
